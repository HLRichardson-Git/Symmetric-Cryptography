...
int main()
{
    ...
    std::string masterKey = "10a58869d74be5a374cf867cfb473859";    // COMMENT FOR DEBUG
    //std::string masterKey = "10a58869d74be5a374cf867cfb473859";  // UNCOMMENT FOR DEBUG
    ...
    std::cout << "Decrypted Ciphertext: " << decryptedCiphertext << std::endl;
