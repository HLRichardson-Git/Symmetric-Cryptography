...
public:
	...
	std::string run(unsigned char plaintext[4][4], unsigned char roundKey[4][4][11]);
...
private:
	...
	void addRoundKey(int round, unsigned char plaintext[4][4], unsigned char roundKey[4][4][11]);
