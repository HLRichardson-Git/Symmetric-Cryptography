...
std::string Decryption::run(unsigned char ciphertext[4][4], unsigned char roundKey[4][4][13])
{
...
void Decryption::invAddRoundKey(int round, unsigned char ciphertext[4][4], unsigned char roundKey[4][4][13])
{
