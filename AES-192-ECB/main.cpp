...
int main()
{
    ...
    //std::string masterKey = "e9f065d7c13573587f7875357dfbb16c53489f6a4bd0f7cd";    // COMMENT FOR DEBUG
    std::string masterKey = "e9f065d7c13573587f7875357dfbb16c53489f6a4bd0f7cd";  // UNCOMMENT FOR DEBUG
