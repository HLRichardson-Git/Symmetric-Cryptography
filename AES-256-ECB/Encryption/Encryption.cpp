...
std::string Encryption::run(unsigned char plaintext[4][4], unsigned char roundKey[4][4][15])
{
...
void Encryption::addRoundKey(int round, unsigned char plaintext[4][4], unsigned char roundKey[4][4][15])
{
